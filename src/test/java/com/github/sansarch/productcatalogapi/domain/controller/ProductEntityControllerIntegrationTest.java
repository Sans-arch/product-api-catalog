...
class ProductEntityControllerIntegrationTest extends BaseIntegrationTest {
    ...
    private String createProduct(ProductRequestDTO dto) throws Exception {
    ...
    void shouldReturn404WhenProductNotFound() throws Exception {
        ...
        mockMvc.perform(get("/api/products/" + randomId))
                ...
                .andExpect(jsonPath("$.message").value(containsString(randomId)));
    }
    ...
    void shouldReturnProductById() throws Exception {
        String id = createProduct(MACBOOK);
    ...
    void shouldReturn404WhenUpdatingNonExistentProduct() throws Exception {
        String randomId = UUID.randomUUID().toString();
        mockMvc.perform(put("/api/products/" + randomId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(MACBOOK)))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.status").value(404));
    ...
    void shouldServeCachedProductWithoutHittingDatabase() throws Exception {
        ...
        assertThat(productsCache.get(UUID.fromString(id))).isNotNull();
    ...
    void shouldEvictCacheAfterDeletion() throws Exception {
        ...
        assertThat(productsCache.get(UUID.fromString(id))).isNull();
    }
